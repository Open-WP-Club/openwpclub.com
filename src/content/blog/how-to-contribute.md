...
Follow the existing code style in the repository. For WordPress plugins, we follow the [WordPress Coding Standards](https://developer.wordpress.org/coding-standards/). For the website, we use TypeScript and Tailwind CSS.
